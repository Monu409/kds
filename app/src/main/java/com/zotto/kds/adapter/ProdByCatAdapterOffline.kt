...
class ProdByCatAdapterOffline (private val mList: List<MProduct>, private val context: Context,private val port: Int, private val ip: String) : RecyclerView.Adapter<ProdByCatAdapterOffline.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.enableBtn.setOnClickListener {
            ...
            messageJson.put("product_id",itemsViewModel.productId)
