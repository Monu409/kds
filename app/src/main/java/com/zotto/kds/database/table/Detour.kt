...
@Entity(tableName = "detour")
class Detour() :Parcelable{
    ...
    companion object CREATOR : Parcelable.Creator<Detour> {
        override fun createFromParcel(parcel: Parcel): Detour {
            return Detour(parcel)
        }

        override fun newArray(size: Int): Array<Detour?> {
